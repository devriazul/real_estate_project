                ...
                <div class="login-form">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="customer-forget-password" class="primary-color">Forget Password?</a>
                        </div>
                        <div class="mb-3">
                            <a href="customer-registration" class="primary-color">Don't have an account? Create Account</a>
                        </div>
                    </form>
                </div>
            </div>
