            ...
            <div class="col-lg-8 col-md-12">
                <div class="left-item">
                    <div class="main-photo">
                        <img src="uploads/<?php echo $result[0]['featured_photo']; ?>" alt="">
                    </div>
                    <h2>
                        Description
                    </h2>
                        ...
                        <div class="row">
                            ...
                            foreach ($result1 as $row) {
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="item">
                                        <a href="uploads/<?php echo $row['photo']; ?>" class="magnific">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="detail">
                                                ...
                                                <div class="agent-section">
                                                    ...
                                                    <?php else:  ?>
                                                        <img class="agent-photo" src="uploads/<?php echo $row['agent_photo']; ?>" alt="">
                                                    <?php endif;  ?>
            ...
            <div class="col-lg-4 col-md-12">
                ...
                <div class="right-item">
                    ...
                    <div class="agent-right d-flex justify-content-start">
                        <div class="left">
                            <img src="uploads/<?php echo $result[0]['agent_photo']; ?>" alt="">
                        </div>
                        <div class="right">
                ...
                <div class="right-item">
                    ...
                    <div class="enquery-form">
                        <form action="ajax-enquery.php" method="post" class="form_enquery">
