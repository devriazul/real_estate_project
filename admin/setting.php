                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="partial-item">
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <img src="uploads/<?php echo $result[0]['logo']; ?>" alt="" class="w_100">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <img src="uploads/<?php echo $result[0]['favicon']; ?>" alt="" class="w_50">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                ...
                                <div class="partial-item">
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <img src="uploads/banner.jpg" alt="" class="w_300">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                ...
                                <div class="partial-item">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <img src="uploads/<?php echo $result[0]['hero_photo']; ?>" alt="" class="w_300">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                ...
                                <div class="partial-item">
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Existing Photo</label>
                                        <div>
                                            <img src="uploads/<?php echo $result[0]['why_choose_photo']; ?>" alt="" class="w_300">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Change Photo</label>
                                ...
                                <div class="partial-item">
                                    ...
                                    <div class="form-group mb-3">
                                        <label>Existing Photo</label>
                                        <div>
                                            <img src="uploads/<?php echo $result[0]['testimonial_photo']; ?>" alt="" class="w_300">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Change Photo</label>
