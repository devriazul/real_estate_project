            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <ul class="useful-links">
                            <li><a href="">Home</a></li>
                            <li><a href="properties.php?name=&location_id=&type_id=&amenity_id=&purpose=&bedrooms=&bathrooms=&price=&p=1">Properties</a></li>
                    ...
                    <div class="item">
                        ...
                        <ul class="useful-links">
                            ...
                            foreach ($result as $row) {
                                ?>
                                <li><a href="location/<?php echo $row['slug']; ?>"><?php echo $row['name']; ?></a></li>
                                <?php
                            }
                            ?>
                        </ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        ...
                        <form action="ajax-newsletter.php" method="post" class="form_newsletter">
