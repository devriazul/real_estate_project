                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="w-150">
                                        <a href="agent-photo-gallery/<?php echo $row['id']; ?>" class="btn btn-primary btn-sm btn-sm-custom w-100-p mb_5">Photo Gallery</a>
                                        <a href="agent-video-gallery/<?php echo $row['id']; ?>" class="btn btn-primary btn-sm btn-sm-custom w-100-p mb_5">Video Gallery</a>
                                    </td>
                                    <td class="w-150">
                                        ...
                                        <a href="agent-property-edit/<?php echo $row['id']; ?>" class="btn btn-warning btn-sm text-white"><i class="fas fa-edit"></i></a>
                                        <a href="agent-property-delete/<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');"><i class="fas fa-trash-alt"></i></a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group row bdb1 pt_10 mb_0">
                                                            ...
                                                            <div class="col-md-8">
                                                                <img src="uploads/<?php echo $row['featured_photo']; ?>" alt="" class="w-200">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row bdb1 pt_10 mb_0">
