                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $row) {
                                            ...
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <img src="uploads/<?php echo $row['featured_photo']; ?>" alt="" class="w_100">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <img src="uploads/<?php echo $row['agent_photo']; ?>" alt="" class="w_50"><br>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group row bdb1 pt_10 mb_0">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <img src="uploads/<?php echo $row['featured_photo']; ?>" alt="" class="w_200">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row bdb1 pt_10 mb_0">
                                                                    ...
                                                                    <div class="form-group row bdb1 pt_10 mb_0">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            ...
                                                                            foreach ($result1 as $row1) {
                                                                                ?>
                                                                                <img src="uploads/<?php echo $row1['photo']; ?>" alt="" class="w_200">
                                                                                <?php
                                                                            }
                                                                            ?>
                                                                        </div>
