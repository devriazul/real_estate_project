...
<div class="slider" style="background-image: url(uploads/<?php echo $result[0]['hero_photo']; ?>)">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            ...
            else
            {
                foreach ($result1 as $row) {
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="item">
                            <div class="photo">
                                <img class="main" src="uploads/<?php echo $row['featured_photo']; ?>" alt="">
                                <div class="top">
                                ...
                                <div class="wishlist"><a href="customer-wishlist-add.php?id=<?php echo $row['id']; ?>"><i class="far fa-heart"></i></a></div>
                            </div>
                            <div class="text">
                                <h3><a href="property/<?php echo $row['id']; ?>/<?php echo $row['slug']; ?>"><?php echo $row['name']; ?></a></h3>
                                <div class="detail">
                                    <div class="stat">
                                    ...
                                    <div class="agent-section">
                                        <?php if($row['photo'] == ''):  ?>
                                            <img class="agent-photo" src="uploads/default.png" alt="">
                                        <?php else:  ?>
                                            <img class="agent-photo" src="uploads/<?php echo $row['photo']; ?>" alt="">
                                        <?php endif;  ?>
...
<div class="why-choose" style="background-image: url('uploads/<?php echo $result[0]['why_choose_photo']; ?>')">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading">
            ...
            foreach ($result1 as $row) {
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="item">
                        ...
                        <div class="text">
                            <h2>
                                <a href="agent/<?php echo $row['id']; ?>"><?php echo $row['full_name']; ?></a>
                            </h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            foreach ($result1 as $row) {
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="item">
                        <div class="photo">
                            <a href="location/<?php echo $row['location_slug']; ?>"><img src="uploads/<?php echo $row['location_photo']; ?>" alt=""></a>
                        </div>
                        <div class="text">
                            <h2><a href="location/<?php echo $row['location_slug']; ?>"><?php echo $row['location_name']; ?></a></h2>
...
<div class="testimonial" style="background-image: url('uploads/<?php echo $result[0]['testimonial_photo']; ?>')">
    <div class="bg"></div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                foreach($result1 as $row) {
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item">
                            ...
                            <div class="text">
                                <h2>
                                    <a href="post/<?php echo $row['slug']; ?>"><?php echo $row['title']; ?></a>
                                </h2>
                                <div class="short-des">
                                    <p>
                                ...
                                <div class="button">
                                    <a href="post/<?php echo $row['slug']; ?>" class="btn btn-primary">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
